...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href='https://github.com/Aditya08q/Equation_solver'>Source Code</a></p>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href=''>Explore my Codes</a></p>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href='https://www.linkedin.com/in/aditya-srivastava-388953254/'>Connect with me on LinkedIn</a></p>", unsafe_allow_html=True)
data = st_canvas(
